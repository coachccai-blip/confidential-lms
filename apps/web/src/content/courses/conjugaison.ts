        ...
        },
        {
          ...
          blocks: [
            ...
            },
            {
              type: 'interactive',
              emoji: '✏️',
              title: t('Un passé avant le passé', 'A past before the past', '过去之前的过去'),
              hint: t('L’action la plus ancienne prend le plus-que-parfait.', 'The earlier action takes the pluperfect.', '更早的动作用愈过去时。'),
              widget: {
                kind: 'fill',
                ...
                items: [
                  {
                    id: 'f1',
                    before: 'Quand je suis arrivé, le film',
                    after: 'déjà.',
                    options: ['avait commencé', 'a commencé', 'commençait'],
                    answer: 'avait commencé',
                    why: t('Le début du film précède mon arrivée : plus-que-parfait. « Déjà » est l’indice classique.', 'The film started before I arrived: pluperfect. “Déjà” is the classic clue.', '电影开场早于我的到达：用愈过去时。“déjà” 是经典提示。'),
                  },
                  {
                    id: 'f2',
                    before: 'Elle m’a rendu le livre que je lui',
                    after: 'l’an dernier.',
                    options: ['avais prêté', 'ai prêté', 'prêtais'],
                    answer: 'avais prêté',
                    why: t('Le prêt précède la restitution : l’action la plus ancienne recule au plus-que-parfait.', 'The lending precedes the returning: the earlier action steps back to the pluperfect.', '借出早于归还：更早的动作退到愈过去时。'),
                  },
                  {
                    id: 'f3',
                    before: 'Ils étaient épuisés parce qu’ils',
                    after: 'toute la nuit.',
                    options: ['avaient conduit', 'ont conduit', 'conduisaient'],
                    answer: 'avaient conduit',
                    why: t('La cause (conduire) précède l’état (épuisés) : plus-que-parfait après « parce que ».', 'The cause (driving) precedes the state (exhausted): pluperfect after “parce que”.', '原因（开车）早于状态（精疲力竭）：“parce que” 后用愈过去时。'),
                  },
                ],
              },
            },
      ...
      lessons: [
        {
          ...
          blocks: [
            ...
            },
            {
              type: 'interactive',
              emoji: '✏️',
              title: t('Futur ou conditionnel ?', 'Future or conditional?', '将来时还是条件式？'),
              hint: t('Certain → futur. Sous condition ou par politesse → conditionnel.', 'Certain → future. Conditional on something, or polite → conditional.', '确定 → 将来时。有前提或表客气 → 条件式。'),
              widget: {
                kind: 'fill',
                prompt: t('Choisissez la forme :', 'Pick the form:', '选出形式：'),
                items: [
                  {
                    id: 'f1',
                    before: 'Demain, je',
                    after: 'les résultats au directeur.',
                    options: ['présenterai', 'présenterais'],
                    answer: 'présenterai',
                    why: t('« Demain » + fait décidé : futur simple. Le conditionnel affaiblirait l’engagement.', '“Demain” + a settled fact: simple future. The conditional would weaken the commitment.', '“demain” 加已定之事：用简单将来时。条件式会削弱承诺。'),
                  },
                  {
                    id: 'f2',
                    before: 'À ta place, je',
                    after: 'plus tôt.',
                    options: ['partirais', 'partirai'],
                    answer: 'partirais',
                    why: t('« À ta place » pose une condition irréelle : conditionnel. Le -s final change tout le sens.', '“À ta place” sets an unreal condition: conditional. The final -s changes the whole meaning.', '“à ta place” 设定了非现实条件：用条件式。词尾的 -s 改变整个意思。'),
                  },
                  {
                    id: 'f3',
                    before: 'S’il pleut samedi, nous',
                    after: 'le pique-nique.',
                    options: ['annulerons', 'annulerions'],
                    answer: 'annulerons',
                    why: t('« Si + présent » appelle le futur : la condition est réelle. « Si + imparfait » appellerait le conditionnel.', '“Si + present” calls for the future: the condition is real. “Si + imperfect” would call for the conditional.', '“si + 现在时”接将来时：条件是现实的。“si + 未完成过去时”才接条件式。'),
                  },
                ],
              },
            },
        ...
        },
        {
          ...
          blocks: [
            ...
            },
            {
              ...
              text: t(
                'À l’oral, {prenom}, si le subjonctif ne vient pas, changez de construction : « Il faut que tu partes » devient « Tu dois partir ». C’est correct, naturel, et cela vaut mieux qu’une forme fautive. À l’écrit en revanche, le subjonctif est attendu et rapporte des points.',
                'In speech, {prenom}, if the subjunctive will not come, change the construction: “Il faut que tu partes” becomes “Tu dois partir”. That is correct, natural, and better than a wrong form. In writing, however, the subjunctive is expected and earns marks.',
                '{prenom}，口语中若一时想不出虚拟式，可改变句式：“Il faut que tu partes”改为“Tu dois partir”。这样既正确又自然，好过用错形式。但在书面表达中，虚拟式是被期待的，并能得分。',
              ),
            },
            {
              type: 'interactive',
              emoji: '✏️',
              title: t('Indicatif ou subjonctif ?', 'Indicative or subjunctive?', '直陈式还是虚拟式？'),
              hint: t('Fait posé comme réel → indicatif. Souhait, doute, nécessité → subjonctif.', 'Stated as fact → indicative. Wish, doubt, necessity → subjunctive.', '当作事实 → 直陈式。愿望、怀疑、必要 → 虚拟式。'),
              widget: {
                kind: 'fill',
                prompt: t('Choisissez la forme :', 'Pick the form:', '选出形式：'),
                items: [
                  {
                    ...
                    after: 'à l’heure demain.',
                    options: ['sois', 'es', 'seras'],
                    answer: 'sois',
                    why: t('« Il faut que » impose le subjonctif, toujours : il faut que tu sois.', '“Il faut que” always forces the subjunctive: il faut que tu sois.', '“il faut que” 永远要求虚拟式：il faut que tu sois。'),
                  },
                  {
                    id: 'f2',
                    before: 'Je pense qu’il',
                    after: 'raison.',
                    options: ['a', 'ait'],
                    answer: 'a',
                    why: t('« Penser que » à l’affirmatif pose un fait : indicatif. La négation basculerait au subjonctif.', 'Affirmative “penser que” states a fact: indicative. The negative would flip to the subjunctive.', '肯定式的 “penser que” 陈述事实：用直陈式。否定式才转虚拟式。'),
                  },
                  {
                    id: 'f3',
                    before: 'Je ne crois pas qu’elle',
                    after: 'venir ce soir.',
                    options: ['puisse', 'peut', 'pourra'],
                    answer: 'puisse',
                    why: t('La négation du verbe d’opinion introduit le doute : subjonctif — qu’elle puisse.', 'Negating the opinion verb introduces doubt: subjunctive — qu’elle puisse.', '否定意见动词引入怀疑：用虚拟式——qu’elle puisse。'),
                  },
                ],
              },
            },
