      ...
      lessons: [
        {
          ...
          blocks: [
            ...
            },
            {
              ...
              text: t(
                'La règle « pays en -e = féminin » a quelques exceptions : le Mexique, le Cambodge, le Mozambique. On dit donc « au Mexique ». Elles sont assez rares pour être apprises une par une.',
                'The rule “country ending in -e = feminine” has a few exceptions: le Mexique, le Cambodge, le Mozambique. So you say “au Mexique”. They are rare enough to be learned one by one.',
                '“以 -e 结尾的国家为阴性”这条规则有少数例外：le Mexique、le Cambodge、le Mozambique。所以要说 “au Mexique”。数量少，可逐个记忆。',
              ),
            },
        ...
        },
        {
          ...
          blocks: [
            ...
            },
            {
              type: 'interactive',
              emoji: '✏️',
              title: t('Le pronom « en » au quotidien', 'The pronoun “en” in daily life', '日常中的代词 “en”'),
              hint: t('« En » remplace la chose ; la quantité, elle, reste.', '“En” replaces the thing; the quantity stays.', '“en” 替代事物；数量则保留。'),
              widget: {
                kind: 'fill',
                ...
                items: [
                  {
                    id: 'f1',
                    before: 'Vous avez des tomates ? — Oui, j’',
                    after: 'ai un kilo.',
                    options: ['en', 'les', 'y'],
                    answer: 'en',
                    why: t('Une quantité : « en » obligatoire. « J’ai un kilo » tout seul est impossible en français.', 'A quantity: “en” is compulsory. Bare “j’ai un kilo” is impossible in French.', '涉及数量：必须用 “en”。法语不能只说 “j’ai un kilo”。'),
                  },
                  {
                    id: 'f2',
                    before: 'Tu veux du café ? — Non merci, je n’',
                    after: 'veux pas.',
                    options: ['en', 'le', 'y'],
                    answer: 'en',
                    why: t('« Du café » cache un « de » : donc « en », même dans la négation.', '“Du café” hides a “de”: so “en”, even in the negative.', '“du café” 里藏着 “de”：所以用 “en”，否定句也一样。'),
                  },
                  {
                    id: 'f3',
                    before: 'Des frères ? — J’',
                    ...
                    options: ['en', 'les', 'me'],
                    answer: 'en',
                    why: t('Le nombre reste en fin de phrase, « en » prend la place du nom : j’en ai deux.', 'The number stays at the end, “en” stands in for the noun: j’en ai deux.', '数字留在句尾，“en” 顶替名词：j’en ai deux。'),
                  },
                ],
              },
            },
