        ...
        },
        {
          ...
          blocks: [
            ...
            },
            {
              type: 'interactive',
              emoji: '✏️',
              title: t('La meilleure reformulation', 'The best rewording', '最佳转述'),
              hint: t('Fidèle au sens, autre syntaxe, registre égal ou supérieur.', 'True to the meaning, different syntax, equal or higher register.', '忠于原意、句式不同、语体持平或更高。'),
              widget: {
                kind: 'fill',
                prompt: t('Quelle reformulation est la plus juste ?', 'Which rewording is the most accurate?', '哪个转述最贴切？'),
                items: [
                  {
                    id: 'f1',
                    before: '« On ne peut pas tout vérifier. » →',
                    after: '',
                    options: ['Une vérification exhaustive est impossible.', 'Il est impossible de vérifier.', 'On vérifie ce qu’on veut.'],
                    answer: 'Une vérification exhaustive est impossible.',
                    why: t('La nominalisation monte le registre en gardant le sens exact. « Il est impossible de vérifier » perd le « tout ».', 'Nominalisation raises the register while keeping the exact meaning. “Il est impossible de vérifier” loses the “tout”.', '名词化提升了语体，又保住了原意。“Il est impossible de vérifier” 丢掉了 “tout”。'),
                  },
                  {
                    id: 'f2',
                    before: '« Les gens n’y croient plus. » →',
                    after: '',
                    options: ['La confiance s’est érodée.', 'Personne n’a jamais cru cela.', 'Les gens détestent cela.'],
                    answer: 'La confiance s’est érodée.',
                    why: t('« S’éroder » rend le « ne plus » : une perte progressive. Les deux autres déforment l’intensité ou la chronologie.', '“S’éroder” renders the “ne plus”: a gradual loss. The other two distort the intensity or the timeline.', '“s’éroder” 传达了 “ne plus”：逐渐流失。另两个选项歪曲了程度或时间线。'),
                  },
                ],
              },
            },
      ...
      lessons: [
        {
          ...
          blocks: [
            ...
            },
            {
              type: 'interactive',
              emoji: '🔢',
              title: t('L’article, du dossier au texte', 'The article, from dossier to text', '从材料到成文的文章'),
              hint: t('Le genre demandé — article, rapport, lettre ouverte — se décide dès la première étape.', 'The required genre — article, report, open letter — is settled at step one.', '要求的文体——文章、报告或公开信——第一步就要定下。'),
              widget: {
                kind: 'order',
                prompt: t('De la consigne à la relecture :', 'From the instructions to the reread:', '从题目要求到复查：'),
                items: [
                  { id: 'o1', text: t('Identifier le genre, le destinataire et le registre exigés', 'Identify the required genre, audience and register', '认定要求的文体、读者与语体') },
                  { id: 'o2', text: t('Extraire du dossier les faits et les positions utiles', 'Pull the useful facts and positions from the dossier', '从材料中提取有用的事实与立场') },
                  { id: 'o3', text: t('Construire un angle : ce que VOTRE texte soutient', 'Build an angle: what YOUR text argues', '确立角度：你的文章主张什么') },
                  { id: 'o4', text: t('Rédiger avec titre, chapeau et intertitres si le genre le veut', 'Write with headline, standfirst and crossheads if the genre calls for them', '按文体需要写出标题、导语和小标题') },
                  { id: 'o5', text: t('Relire pour le registre : aucune trace d’oral familier', 'Reread for register: no trace of casual speech', '按语体复查：不留任何口语痕迹') },
                ],
                successNote: t(
                  'Un article sans angle n’est qu’un résumé paginé : l’angle est ce que le C2 évalue vraiment.',
                  'An article with no angle is just a paginated summary: the angle is what C2 actually assesses.',
                  '没有角度的文章只是排了版的摘要：角度才是 C2 真正考查的东西。',
                ),
              },
            },
          ],
        },
        {
          ...
          blocks: [
            ...
            },
            {
              ...
              text: t(
                'Relisez votre texte à voix haute, {prenom}. Si vous manquez de souffle, vos phrases sont trop longues. Si le rythme est monotone, alternez : une phrase longue, une phrase courte. Le C2 s’entend autant qu’il se lit.',
                'Read your text aloud, {prenom}. If you run out of breath, your sentences are too long. If the rhythm is monotonous, alternate: one long sentence, one short. C2 is heard as much as it is read.',
                '{prenom}，把文章朗读一遍。若感到气不够用，说明句子太长；若节奏单调，就交替使用长句与短句。C2 的水准既看得见，也听得出。',
              ),
            },
            {
              type: 'quote',
            ...
            },
            {
              type: 'interactive',
              emoji: '✏️',
              title: t('Choisissez la phrase qui a une voix', 'Pick the sentence with a voice', '选出有声音的句子'),
              hint: t('À contenu égal, la forme départage.', 'With equal content, form decides.', '内容相当时，形式定高下。'),
              widget: {
                kind: 'fill',
                prompt: t('Quelle version est du niveau C2 ?', 'Which version is C2-grade?', '哪个版本达到 C2 水准？'),
                items: [
                  {
                    id: 'f1',
                    before: 'Pour ouvrir un éditorial :',
                    after: '',
                    options: ['On promettait la transparence. Restent les zones d’ombre.', 'Il y a beaucoup de zones d’ombre dans ce dossier.', 'Ce dossier est un peu opaque, c’est dommage.'],
                    answer: 'On promettait la transparence. Restent les zones d’ombre.',
                    why: t('Phrase courte après l’imparfait de promesse, inversion « restent » : le contraste fait la voix. Les deux autres constatent sans relief.', 'A short sentence after the imperfect of promise, with the inversion “restent”: the contrast creates the voice. The other two state without relief.', '许诺用未完成过去时，再接倒装的短句 “restent”：反差造就了声音。另两个只是平铺直叙。'),
                  },
                  {
                    id: 'f2',
                    before: 'Pour conclure :',
                    after: '',
                    options: ['La question n’est plus de savoir si, mais quand.', 'On verra bien ce qui se passera plus tard.', 'En conclusion, c’est un sujet très important.'],
                    answer: 'La question n’est plus de savoir si, mais quand.',
                    why: t('L’ellipse « si… quand » ferme le texte sur une tension. « C’est un sujet important » est la conclusion que tous les correcteurs redoutent.', 'The “si… quand” ellipsis closes the text on a tension. “C’est un sujet important” is the conclusion every marker dreads.', '“si… quand” 的省略句让文章在张力中收束。“c’est un sujet important” 则是所有阅卷人最怕见到的结尾。'),
                  },
                ],
              },
            },
