          ...
          blocks: [
            {
              type: 'paragraph',
              text: t(
                'En français, tout nom porte un [[genre|genre]] : masculin ou féminin. Ce n’est pas une question de logique — une table n’a rien de féminin. C’est une propriété du mot, à connaître pour accorder le [[determinant|déterminant]] et l’adjectif. La bonne nouvelle : la terminaison du nom permet de deviner juste dans environ 80 % des cas.',
                'In French every noun carries a [[genre|gender]]: masculine or feminine. It is not a matter of logic — a table is not feminine in any real sense. It is a property of the word, one you need to know to make the [[determinant|determiner]] and the adjective agree. The good news: the ending of the noun lets you guess correctly about 80% of the time.',
                '在法语中，每个名词都有[[genre|性]]：阳性或阴性。这并非逻辑问题——桌子本身并无阴性可言。性是词语的属性，掌握了它才能让[[determinant|限定词]]和形容词正确配合。好消息是：名词词尾能让你在约 80% 的情况下猜对。',
              ),
            },
            ...
            },
            {
              type: 'interactive',
              emoji: '✏️',
              title: t('Devinez le genre à la terminaison', 'Guess the gender from the ending', '看词尾猜性'),
              hint: t('La terminaison donne la bonne réponse dans 80 % des cas.', 'The ending gives the right answer 80% of the time.', '词尾在 80% 的情况下都能给出正确答案。'),
              widget: {
                kind: 'fill',
                prompt: t('Le ou la ?', 'Le or la?', 'le 还是 la？'),
                items: [
                  {
                    id: 'f1',
                    before: 'Nous attendons',
                    after: 'décision du jury.',
                    options: ['la', 'le'],
                    answer: 'la',
                    why: t('Les noms en -tion sont féminins, presque sans exception.', 'Nouns in -tion are feminine, almost without exception.', '-tion 结尾的名词是阴性，几乎没有例外。'),
                  },
                  {
                    id: 'f2',
                    before: 'Il étudie',
                    after: 'système de santé.',
                    options: ['le', 'la'],
                    answer: 'le',
                    why: t('Les noms en -ème (système, problème, thème) sont masculins malgré leur air féminin.', 'Nouns in -ème (système, problème, thème) are masculine despite their feminine look.', '-ème 结尾的名词（système、problème、thème）虽然长得像阴性，其实是阳性。'),
                  },
                  {
                    id: 'f3',
                    before: 'On admire',
                    after: 'courage de cette équipe.',
                    options: ['le', 'la'],
                    answer: 'le',
                    why: t('Les noms en -age sont masculins — sauf plage, page, image, cage, nage.', 'Nouns in -age are masculine — except plage, page, image, cage, nage.', '-age 结尾的名词是阳性——除了 plage、page、image、cage、nage。'),
                  },
                ],
              },
            },
        ...
        },
        {
          ...
          blocks: [
            ...
            },
            {
              ...
              text: t(
                'Un [[verbe-pronominal|verbe pronominal]] se conjugue avec être, mais l’accord suit en réalité la règle du COD. « Elles se sont lavées » : se est COD, on accorde. « Elles se sont lavé les mains » : le COD « les mains » est placé après, pas d’accord.',
                'A [[verbe-pronominal|reflexive verb]] takes “être”, but agreement actually follows the direct-object rule. “Elles se sont lavées”: se is the object, so it agrees. “Elles se sont lavé les mains”: the object “les mains” comes after, so no agreement.',
                '[[verbe-pronominal|自反动词]]用 être，但配合实际遵循直接宾语规则。“Elles se sont lavées”：se 是宾语，要配合。“Elles se sont lavé les mains”：宾语 “les mains” 在动词后，不配合。',
              ),
            },
            {
              type: 'callout',
      ...
      lessons: [
        {
          ...
          blocks: [
            ...
            },
            {
              ...
              text: t(
                'On emploie « dont » quand la subordonnée se construit avec « de ». C’est le cas de parler **de**, avoir besoin **de**, être fier **de**, le prix **de**. Erreur fréquente : « le livre dont j’ai besoin **de** » — le « de » est déjà contenu dans « dont ».',
                'Use “dont” when the clause is built with “de”. That covers parler **de**, avoir besoin **de**, être fier **de**, le prix **de**. A frequent error: “le livre dont j’ai besoin **de**” — the “de” is already inside “dont”.',
                '当从句与 “de” 搭配时使用 “dont”。这包括 parler **de**、avoir besoin **de**、être fier **de**、le prix **de**。常见错误：“le livre dont j’ai besoin **de**”——“de”已经包含在“dont”之中。',
              ),
            },
            {
              type: 'examples',
            ...
            },
            {
              type: 'interactive',
              emoji: '✏️',
              title: t('Le bon relatif, au premier regard', 'The right relative, at first glance', '一眼选对关系代词'),
              hint: t('Regardez ce qui suit le trou : verbe direct, sujet, ou trace de « de ».', 'Look at what follows the gap: a bare verb, a subject, or a trace of “de”.', '看空格后面是什么：动词、主语，还是 “de” 的踪迹。'),
              widget: {
                kind: 'fill',
                prompt: t('Qui, que, dont ou où ?', 'Qui, que, dont or où?', 'qui、que、dont 还是 où？'),
                items: [
                  {
                    id: 'f1',
                    before: 'Le dossier',
                    after: 'tu as préparé est excellent.',
                    options: ['que', 'qui', 'dont'],
                    answer: 'que',
                    why: t('Un sujet (« tu ») s’intercale avant le verbe : c’est « que », le relatif complément.', 'A subject (“tu”) comes in before the verb: “que”, the object relative.', '动词前插入了主语 “tu”：用宾语关系代词 “que”。'),
                  },
                  {
                    id: 'f2',
                    before: 'C’est un sujet',
                    after: 'on parle beaucoup en ce moment.',
                    options: ['dont', 'que', 'qui'],
                    answer: 'dont',
                    why: t('Parler **de** quelque chose : le « de » impose « dont ». Séparez la phrase pour le vérifier.', 'To speak **de** something: the “de” requires “dont”. Split the sentence to check.', '“parler de”：这个 de 要求用 “dont”。把句子拆开即可验证。'),
                  },
                  {
                    id: 'f3',
                    before: 'Je me souviens du jour',
                    after: 'nous nous sommes rencontrés.',
                    options: ['où', 'que', 'quand'],
                    answer: 'où',
                    why: t('« Le jour » est un moment : le relatif est « où », jamais « quand » après un nom.', '“Le jour” is a time: the relative is “où”, never “quand” after a noun.', '“le jour” 是时间：关系代词用 “où”，名词后绝不用 “quand”。'),
                  },
                ],
              },
            },
        ...
        },
        {
          ...
          blocks: [
            ...
            },
            {
              ...
              text: t(
                'Visez trois connecteurs différents par paragraphe, {prenom}, jamais le même deux fois de suite. Un texte B2 qui enchaîne « et… et… et… » plafonne à la moyenne, quelle que soit la richesse des idées.',
                'Aim for three different connectors per paragraph, {prenom}, never the same one twice in a row. A B2 text that strings together “et… et… et…” will not rise above average, however rich the ideas.',
                '{prenom}，每段争取使用三个不同的连接词，切勿连续重复同一个。一篇不断使用“et… et… et…”的 B2 作文，无论内容多丰富，也只能得到中等分数。',
              ),
            },
            {
              type: 'interactive',
              emoji: '🔗',
              title: t('Chaque connecteur à son rôle', 'Each connector in its role', '每个连接词各司其职'),
              hint: t('Cause, but, conséquence, opposition : quatre directions.', 'Cause, purpose, consequence, contrast: four directions.', '原因、目的、结果、对立：四个方向。'),
              widget: {
                kind: 'pairs',
                prompt: t('Ce connecteur exprime…', 'This connector expresses…', '这个连接词表达……'),
                pairs: [
                  { id: 'p1', left: 'puisque', right: t('une cause déjà connue de l’interlocuteur', 'a cause the listener already knows', '对方已知的原因') },
                  { id: 'p2', left: 'pour que + subjonctif', right: t('le but visé', 'the goal aimed at', '所追求的目的') },
                  { id: 'p3', left: 'si bien que', right: t('la conséquence qui en découle', 'the consequence that follows', '由此产生的结果') },
                  { id: 'p4', left: 'pourtant', right: t('une opposition inattendue', 'an unexpected contrast', '出人意料的对立') },
                  { id: 'p5', left: 'grâce à', right: t('une cause au résultat heureux', 'a cause with a happy outcome', '带来好结果的原因') },
                ],
              },
            },
          ],
