        ...
        },
        {
          ...
          blocks: [
            ...
            { type: 'heading', emoji: '✍️', text: t('Épeler son nom', 'Spelling your name', '拼读姓名') },
            {
              type: 'paragraph',
              text: t(
                'On vous demandera souvent « Vous pouvez épeler ? ». Sept lettres posent problème parce qu’elles ne se prononcent pas comme en anglais. Les voici : **E** [ə], **I** [i], **G** [ʒe], **J** [ʒi], **Y** [igʁɛk], **W** [dubləve], **R** [ɛʁ].',
                'You will often be asked “Vous pouvez épeler ?”. Seven letters trip learners up because they are not pronounced as in English. Here they are: **E** [ə], **I** [i], **G** [ʒe], **J** [ʒi], **Y** [igʁɛk], **W** [dubləve], **R** [ɛʁ].',
                '别人常会问 “Vous pouvez épeler ?”。有七个字母的读法与英语不同，最容易出错。它们是：**E** [ə]、**I** [i]、**G** [ʒe]、**J** [ʒi]、**Y** [igʁɛk]、**W** [dubləve]、**R** [ɛʁ]。',
              ),
            },
            {
              type: 'keyvalues',
            ...
            },
            {
              type: 'interactive',
              emoji: '🔗',
              title: t('Question, réponse', 'Question, answer', '一问一答'),
              hint: t('Reliez chaque question à sa réponse naturelle.', 'Match each question to its natural answer.', '把每个问题与自然的回答配对。'),
              widget: {
                kind: 'pairs',
                prompt: t('On vous demande… vous répondez :', 'You are asked… you answer:', '别人问……你答：'),
                pairs: [
                  { id: 'p1', left: 'Comment vous appelez-vous ?', right: t('Je m’appelle Nadia Roche.', 'Je m’appelle Nadia Roche.', 'Je m’appelle Nadia Roche.') },
                  { id: 'p2', left: 'Ça s’écrit comment ?', right: t('R-O-C-H-E.', 'R-O-C-H-E.', 'R-O-C-H-E.') },
                  { id: 'p3', left: 'Vous venez d’où ?', right: t('Je viens du Maroc.', 'Je viens du Maroc.', 'Je viens du Maroc.') },
                  { id: 'p4', left: 'Vous habitez où ?', right: t('J’habite à Lyon.', 'J’habite à Lyon.', 'J’habite à Lyon.') },
                  { id: 'p5', left: 'Enchanté !', right: t('Enchantée, moi de même.', 'Enchantée, moi de même.', 'Enchantée, moi de même.') },
                ],
              },
            },
          ],
        },
        {
          ...
          blocks: [
            ...
            },
            {
              type: 'interactive',
              emoji: '🎧',
              title: t('Les nombres à l’oreille', 'Numbers by ear', '用耳朵抓数字'),
              hint: t('Écoutez — la vitesse lente aide pour les nombres composés.', 'Listen — the slow speed helps with compound numbers.', '仔细听——慢速对组合数字很有帮助。'),
              widget: {
                kind: 'listening',
                prompt: t('Quel nombre ou quelle heure entendez-vous ?', 'Which number or time do you hear?', '你听到的是哪个数字或时间？'),
                items: [
                  {
                    id: 'n1',
                    sentence: 'Ça fait quatre-vingt-quinze euros.',
                    question: t('Quel est le prix ?', 'What is the price?', '价格是多少？'),
                    options: [t('95 euros', '95 euros', '95 欧元'), t('75 euros', '75 euros', '75 欧元'), t('85 euros', '85 euros', '85 欧元')],
                    answer: 0,
                    why: t('Quatre-vingt-quinze = 4 × 20 + 15 = 95. Les nombres en « quatre-vingt » se décodent en calculant.', 'Quatre-vingt-quinze = 4 × 20 + 15 = 95. “Quatre-vingt” numbers are decoded by doing the sum.', 'quatre-vingt-quinze = 4 × 20 + 15 = 95。“quatre-vingt” 系列要靠计算来解码。'),
                  },
                  {
                    id: 'n2',
                    sentence: 'Le train part à dix-sept heures quarante.',
                    question: t('À quelle heure part le train ?', 'What time does the train leave?', '火车几点出发？'),
                    options: [t('17 h 40', '17:40', '17 点 40 分'), t('7 h 40', '7:40', '7 点 40 分'), t('17 h 14', '17:14', '17 点 14 分')],
                    answer: 0,
                    why: t('Les horaires officiels s’annoncent sur 24 heures : dix-sept heures = 17 h.', 'Official times use the 24-hour clock: dix-sept heures = 17 h.', '官方时刻用 24 小时制：dix-sept heures 即 17 点。'),
                  },
                  {
                    id: 'n3',
                    sentence: 'Nous sommes le premier mars.',
                    question: t('Quelle est la date ?', 'What is the date?', '今天是几号？'),
                    options: [t('le 1ᵉʳ mars', 'March 1st', '三月 1 日'), t('le 11 mars', 'March 11th', '三月 11 日'), t('le 3 mars', 'March 3rd', '三月 3 日')],
                    answer: 0,
                    why: t('Seul le premier jour du mois est ordinal : « le premier mars », puis « le deux, le trois… ».', 'Only the first day of the month is ordinal: “le premier mars”, then “le deux, le trois…”.', '只有每月的第一天用序数词：“le premier mars”，之后是 “le deux”“le trois”……'),
                  },
                ],
              },
            },
