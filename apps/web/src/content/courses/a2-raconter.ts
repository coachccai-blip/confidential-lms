      ...
      lessons: [
        {
          ...
          blocks: [
            ...
            },
            {
              type: 'interactive',
              emoji: '✏️',
              title: t('Avoir ou être ?', 'Avoir or être?', 'avoir 还是 être？'),
              hint: t('Les verbes de déplacement et les pronominaux prennent être.', 'Movement verbs and reflexives take être.', '位移动词和自反动词用 être。'),
              widget: {
                kind: 'fill',
                prompt: t('Choisissez l’auxiliaire :', 'Pick the auxiliary:', '选出助动词：'),
                items: [
                  {
                    id: 'f1',
                    before: 'Hier, nous',
                    after: 'arrivés en retard.',
                    options: ['sommes', 'avons'],
                    answer: 'sommes',
                    why: t('« Arriver » est un verbe de déplacement : être, et le participe s’accorde — arrivés.', '“Arriver” is a movement verb: être, and the participle agrees — arrivés.', '“arriver” 是位移动词：用 être，分词要配合——arrivés。'),
                  },
                  {
                    id: 'f2',
                    before: 'Elle',
                    after: 'fini son travail à midi.',
                    options: ['a', 'est'],
                    answer: 'a',
                    why: t('« Finir » prend avoir, comme l’immense majorité des verbes. Pas d’accord : le COD est après.', '“Finir” takes avoir, like the vast majority of verbs. No agreement: the object follows.', '“finir” 用 avoir，和绝大多数动词一样。宾语在后，不配合。'),
                  },
                  {
                    id: 'f3',
                    before: 'Ils se',
                    after: 'levés très tôt.',
                    options: ['sont', 'ont'],
                    answer: 'sont',
                    why: t('Tout verbe pronominal — se lever, se laver — se conjugue avec être, sans exception.', 'Every reflexive verb — se lever, se laver — takes être, without exception.', '所有自反动词——se lever、se laver——一律用 être，没有例外。'),
                  },
                ],
              },
            },
        ...
        },
        {
          ...
          blocks: [
            ...
            },
            {
              type: 'interactive',
              emoji: '✏️',
              title: t('Fabriquez l’imparfait', 'Build the imperfect', '造出未完成过去时'),
              hint: t('Forme « nous » du présent, moins -ons, plus la terminaison.', 'The present “nous” form, minus -ons, plus the ending.', '取现在时 “nous” 形式，去掉 -ons，加上词尾。'),
              widget: {
                kind: 'fill',
                prompt: t('Complétez à l’imparfait :', 'Complete in the imperfect:', '用未完成过去时补全：'),
                items: [
                  {
                    id: 'f1',
                    before: 'Quand j’étais petit, nous',
                    after: 'au bord de la mer.',
                    options: ['habitions', 'habitons', 'avons habité'],
                    answer: 'habitions',
                    why: t('Décor et habitude du passé : imparfait. « Habitons » est le présent, à une lettre près.', 'Background and past habit: imperfect. “Habitons” is the present, one letter away.', '过去的背景与习惯：用未完成过去时。“habitons” 是现在时，只差一个字母。'),
                  },
                  {
                    id: 'f2',
                    before: 'Il',
                    after: 'toujours du thé le soir.',
                    options: ['buvait', 'a bu', 'boit'],
                    answer: 'buvait',
                    why: t('« Toujours » signale la répétition : imparfait. « A bu » raconterait une seule fois.', '“Toujours” signals repetition: imperfect. “A bu” would tell of a single occasion.', '“toujours” 标志着重复：用未完成过去时。“a bu” 只讲一次。'),
                  },
                  {
                    id: 'f3',
                    before: 'Vous',
                    after: 'fatigués après le voyage ?',
                    options: ['étiez', 'êtes été', 'seriez'],
                    answer: 'étiez',
                    why: t('Un état dans le passé se décrit à l’imparfait : « étiez ». « Êtes été » n’existe pas.', 'A past state is described in the imperfect: “étiez”. “Êtes été” does not exist.', '过去的状态用未完成过去时描述：“étiez”。“êtes été” 不存在。'),
                  },
                ],
              },
            },
