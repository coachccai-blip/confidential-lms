          ...
          blocks: [
            ...
            },
            {
              ...
              text: t(
                ...
                'Systematically use the pattern: **device → quotation → effect → meaning**. “The anaphora of ‘rien’ (ll. 4-7) hammers the negation home and turns the description into an indictment.” Without the third and fourth steps there is no analysis.',
                '始终使用这一模式：**手法 → 引文 → 效果 → 意义**。“‘rien’ 的首语重复（第 4—7 行）反复敲击否定，把描写变成了控诉。”缺少第三、第四步就不成其为分析。',
              ),
            },
            {
              type: 'examples',
