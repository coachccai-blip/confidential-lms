        ...
        },
        {
          ...
          blocks: [
            ...
            },
            {
              type: 'interactive',
              emoji: '🎧',
              title: t('L’ironie à l’oreille', 'Irony by ear', '用耳朵辨反讽'),
              hint: t('À l’oral, le contexte fait tout : l’intonation ne suffit jamais.', 'In speech, context does the work: intonation is never enough.', '口语中语境决定一切：光靠语调永远不够。'),
              widget: {
                kind: 'listening',
                prompt: t('Premier ou second degré ?', 'First or second degree?', '正话还是反话？'),
                items: [
                  {
                    id: 'l1',
                    sentence: 'Encore une réunion annulée au dernier moment. J’adore.',
                    question: t('Que ressent la personne ?', 'How does the speaker feel?', '说话人是什么感受？'),
                    options: [t('De l’agacement : « j’adore » est ironique', 'Irritation: “j’adore” is ironic', '恼火：“j’adore” 是反话'), t('Un vrai plaisir', 'Genuine delight', '真心高兴'), t('De l’indifférence', 'Indifference', '无所谓')],
                    answer: 0,
                    why: t('« J’adore » collé à une contrariété est l’ironie orale la plus fréquente du français courant.', '“J’adore” glued to an annoyance is the most frequent spoken irony in everyday French.', '把 “j’adore” 贴在一件烦心事后面，是日常法语最常见的口头反讽。'),
                  },
                  {
                    id: 'l2',
                    sentence: 'Sympa, le cadeau. Non mais vraiment, il ne fallait pas.',
                    question: t('Comment décoder « il ne fallait pas » ?', 'How do you decode “il ne fallait pas”?', '“il ne fallait pas” 该怎么解读？'),
                    options: [t('Selon le ton : remerciement sincère ou pique ironique', 'Depending on tone: sincere thanks or an ironic dig', '视语气而定：真诚道谢或暗带讥讽'), t('Toujours un reproche', 'Always a reproach', '一定是责备'), t('Toujours un refus du cadeau', 'Always a refusal of the gift', '一定是拒收礼物')],
                    answer: 0,
                    why: t('La formule rituelle des cadeaux devient une pique si le « non mais vraiment » appuie trop : seule la situation tranche.', 'The ritual gift phrase turns into a dig when “non mais vraiment” leans too hard: only the situation decides.', '这句送礼客套话若被 “non mais vraiment” 压得太重就变成挖苦：只有情境能给出答案。'),
                  },
                ],
              },
            },
