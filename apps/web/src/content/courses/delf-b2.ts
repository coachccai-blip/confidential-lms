        ...
        },
        {
          ...
          blocks: [
            ...
            },
            {
              type: 'interactive',
              emoji: '🔢',
              title: t('La lettre formelle, bloc par bloc', 'The formal letter, block by block', '正式信函，逐块搭建'),
              hint: t('La moitié de la lettre se prépare avant l’examen.', 'Half the letter can be prepared before the exam.', '信的一半可以在考前就准备好。'),
              widget: {
                kind: 'order',
                prompt: t('Dans quel ordre rédiger ?', 'In what order do you write?', '按什么顺序写？'),
                items: [
                  { id: 'o1', text: t('L’objet : une ligne qui annonce la demande', 'The subject line: one line announcing the request', '事由：一行点明诉求') },
                  { id: 'o2', text: t('L’appel exact : « Madame la Directrice, »', 'The exact greeting: “Madame la Directrice,”', '准确的称呼：“Madame la Directrice,”') },
                  { id: 'o3', text: t('Le rappel des faits, daté et référencé', 'The facts, dated and referenced', '陈述事实，附日期和编号') },
                  { id: 'o4', text: t('La demande, appuyée sur un argument', 'The request, backed by an argument', '提出诉求，佐以论据') },
                  { id: 'o5', text: t('La formule de politesse qui reprend l’appel mot pour mot', 'The closing formula repeating the greeting word for word', '一字不差重复称呼的礼貌套语') },
                ],
                successNote: t(
                  'Objet, appel et formule finale sont préparables à l’avance : à l’examen, seuls les faits et la demande changent.',
                  'Subject, greeting and closing can be prepared in advance: in the exam, only the facts and the request change.',
                  '事由、称呼和结尾套语都能提前备好：考场上只有事实和诉求会变。',
                ),
              },
            },
          ],
      ...
      lessons: [
        {
          ...
          blocks: [
            ...
            },
            {
              type: 'interactive',
              emoji: '🎧',
              title: t('Entendre ce qui n’est pas dit', 'Hearing what is not said', '听出没说出口的'),
              hint: t('L’implicite s’entraîne à l’oreille autant qu’à l’écrit.', 'Implicitness is trained by ear as much as on paper.', '言外之意既要靠读，也要靠听来训练。'),
              widget: {
                kind: 'listening',
                prompt: t('Que laisse entendre la personne ?', 'What is the speaker implying?', '说话人在暗示什么？'),
                items: [
                  {
                    id: 'l1',
                    sentence: 'Disons que ce n’est pas son meilleur film.',
                    question: t('Que pense vraiment la personne ?', 'What does the speaker really think?', '说话人真实的想法是？'),
                    options: [t('Le film est mauvais', 'The film is bad', '这部电影很差'), t('Le film est correct', 'The film is decent', '电影还过得去'), t('Elle n’a pas d’avis', 'They have no opinion', '没有看法')],
                    answer: 0,
                    why: t('« Disons que » + litote : la formule atténue une critique nette. Personne ne dit cela d’un film aimé.', '“Disons que” + litotes: the phrase cushions a sharp criticism. Nobody says this about a film they liked.', '“disons que” 加曲言法：这个句式在缓冲一记明确的批评。喜欢的电影没人会这么说。'),
                  },
                  {
                    id: 'l2',
                    sentence: 'Il paraît que la réunion a encore été reportée.',
                    question: t('Que signale « il paraît que » ?', 'What does “il paraît que” signal?', '“il paraît que” 传递了什么信号？'),
                    options: [t('L’information est de seconde main', 'The information is second-hand', '消息是二手的'), t('L’information est officielle', 'The information is official', '消息是官方的'), t('La personne l’a vérifiée', 'The speaker has checked it', '说话人已核实')],
                    answer: 0,
                    why: t('« Il paraît que » décline la responsabilité : on rapporte une rumeur. Et « encore » glisse un agacement.', '“Il paraît que” declines responsibility: a rumour is being passed on. And “encore” slips in some irritation.', '“il paraît que” 是在推卸责任：转述传闻而已。“encore” 还悄悄夹带了不耐烦。'),
                  },
                ],
              },
            },
        ...
        },
        {
          ...
          blocks: [
            ...
            },
            {
              ...
              text: t(
                'La grille, {prenom}, distingue quatre critères : capacité à argumenter, aisance dans l’interaction, étendue du lexique et correction grammaticale. Les deux premiers pèsent plus que les deux derniers. Un candidat fluide qui fait quelques fautes obtient une meilleure note qu’un candidat irréprochable mais hésitant.',
                'The grid, {prenom}, distinguishes four criteria: ability to argue, ease in interaction, range of vocabulary and grammatical accuracy. The first two weigh more than the last two. A fluent candidate who makes a few mistakes scores higher than a flawless but hesitant one.',
                '{prenom}，评分表分为四项：论证能力、互动流畅度、词汇广度与语法正确性。前两项权重高于后两项。表达流畅但有些许错误的考生，得分高于语言无误却犹豫迟疑的考生。',
              ),
            },
            {
              type: 'interactive',
              emoji: '🔢',
              title: t('Le monologue, minute par minute', 'The monologue, minute by minute', '独白陈述，逐分钟拆解'),
              hint: t('Dix minutes se construisent, elles ne s’improvisent pas.', 'Ten minutes are built, not improvised.', '十分钟是搭出来的，不是即兴的。'),
              widget: {
                kind: 'order',
                prompt: t('De la lecture du document à la conclusion :', 'From reading the document to the conclusion:', '从读材料到收尾：'),
                items: [
                  { id: 'o1', text: t('Dégager le thème et le problème posé par le document', 'Draw out the theme and the problem the document raises', '提炼材料的主题与问题') },
                  { id: 'o2', text: t('Formuler une problématique en une question', 'Turn it into a one-question problématique', '把它化为一个问题式的论题') },
                  { id: 'o3', text: t('Annoncer un plan en deux parties', 'Announce a two-part plan', '宣布两部分的提纲') },
                  { id: 'o4', text: t('Développer chaque partie avec un exemple personnel', 'Develop each part with a personal example', '每部分配一个亲身例子展开') },
                  { id: 'o5', text: t('Conclure et ouvrir vers une question plus large', 'Conclude and open onto a wider question', '收束并引向一个更大的问题') },
                ],
                successNote: t(
                  'C’est le plan que le jury coche pendant que vous parlez : le suivre, c’est remplir sa grille à sa place.',
                  'This is the plan the panel ticks off while you speak: following it fills in their grid for them.',
                  '这正是考官边听边勾的框架：照它来讲，等于替考官把评分表填好。',
                ),
              },
            },
          ],
